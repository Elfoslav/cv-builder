...
export const ProjectCard = ({ name, period, description, stack, stars, repo, link }: ProjectCardProps) => {
  return (
    <div className="cv-project-card group relative flex flex-col overflow-hidden rounded-md border border-border bg-gradient-card p-3.5 shadow-card transition-all hover:border-primary/50 hover:shadow-glow">
      ...
      <p className="mb-2.5 text-sm leading-snug text-muted-foreground">{description}</p>
